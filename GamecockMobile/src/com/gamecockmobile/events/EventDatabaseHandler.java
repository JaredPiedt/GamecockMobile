...
public class EventDatabaseHandler extends SQLiteOpenHelper {
  ...
  public Event getEvent(int id) {
    ...
    Cursor cursor = db.query(TABLE_EVENTS, new String[] { KEY_ID, KEY_NAME, KEY_COURSE, KEY_TYPE, KEY_DATE,
        KEY_NOTIFICATIONS }, KEY_ID + "=?", new String[] { String.valueOf(id) }, null, null, null,
        null);
    if (cursor != null)
      cursor.moveToFirst();
