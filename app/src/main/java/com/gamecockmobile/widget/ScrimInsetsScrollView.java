package com.gamecockmobile.widget;
...
public class ScrimInsetsScrollView extends ScrollView {
     ...
     * UI chrome insets (e.g. a ListView). When using with ListView, remember to set clipToPadding to false.
     */
