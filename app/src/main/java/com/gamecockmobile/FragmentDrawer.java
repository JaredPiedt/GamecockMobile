...
import com.gamecockmobile.model.NavDrawerItem;

/**
 * Created by piedt on 12/23/15.
 */
public class FragmentDrawer extends Fragment {
    ...
    public static List<NavDrawerItem> getData() {
        ...
        // Schedule
        data.add(new NavDrawerItem(navMenuTitles[NAVDRAWER_ITEM_COURSE_LIST], R.drawable.ic_list_grey));
        // Events
        data.add(new NavDrawerItem(navMenuTitles[NAVDRAWER_ITEM_EVENTS], R.drawable.ic_today_grey));
        // Buses
        data.add(new NavDrawerItem("selector", R.drawable.ic_drawer_social));
        // Social
        data.add(new NavDrawerItem(navMenuTitles[NAVDRAWER_ITEM_SOCIAL], R.drawable.ic_people_grey));
        // News
        data.add(new NavDrawerItem(navMenuTitles[NAVDRAWER_ITEM_NEWS], R.drawable.ic_trending_up_grey));
        return data;
    }
